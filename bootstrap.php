...
if ( ! defined( 'UFHEALTH_WHO_WROTE_WHAT_DIR' ) ) {
	define( 'UFHEALTH_WHO_WROTE_WHAT_DIR', 'lang_dir' );
}
if ( ! defined( 'UFHEALTH_WHO_WROTE_WHAT_PATH' ) ) {
	define( 'UFHEALTH_WHO_WROTE_WHAT_PATH', 'path' );
}
